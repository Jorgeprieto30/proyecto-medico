  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 border border-gray-300 bg-white text-gray-700 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors"
      >
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="p-6">
            {tab === 'member' ? (
              <>
                <div className="mb-5">
                  <h2 className="text-lg font-semibold text-gray-900">Ingresa a tu cuenta</h2>
                  <p className="text-sm text-gray-500 mt-0.5">
                    Reserva y gestiona tus citas
                  </p>
                </div>
                <MemberLoginForm />
              </>
